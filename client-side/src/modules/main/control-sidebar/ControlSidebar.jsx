...
const ControlSidebar = () => {
  ...
  const headerFixed = useSelector((state) => state.ui.headerFixed);
  const footerFixed = useSelector((state) => state.ui.footerFixed);
  const navbarVariant = useSelector((state) => state.ui.navbarVariant);
  const sidebarSkin = useSelector((state) => state.ui.sidebarSkin);
  const layoutBoxed = useSelector((state) => state.ui.layoutBoxed);
  const layoutFixed = useSelector((state) => state.ui.layoutFixed);
  ...
  const onNavbarVariantChange = (value) => {
    dispatch(setNavbarVariant(value));
  };

  const onSidebarSkinChange = (value) => {
    ...
    >
      ...
      <div style={{padding: '8px 0'}}>
        ...
        <PfSelect
          ...
          onChange={(e) => onNavbarVariantChange(e.target.value)}
          type="custom"
        />
        <PfSelect
          className="mt-3"
        ...
        <PfSelect
          ...
          type="custom"
          onChange={(e) => onSidebarSkinChange(e.target.value)}
        />
        <PfSelect
          className="mt-3"
