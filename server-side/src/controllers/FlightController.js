...
exports.create = async (req, res) => {
    try {
        ...
        const requiredFields = ['plane_id', 'journey_date', 'source_destination_id', 'destination_id', 'fare', 'seatLeft', 'departure_time', 'arrival_time', 'flight_class'];
        ...
        if (flightExist) {
            return apiResponse.errorResponse(res, "Flight Number is already taken");
        }
        ...
        if (flight) {
            return apiResponse.successResponse(res, 'Flight created successfully!');
        }
...
exports.list = async (req, res) => {
    try {
        ...
        if (flights.length > 0) {
            return apiResponse.successResponseWithData(res, 'Flight retrieval Successful!', flights);
        } else {
...
exports.readById = async (req, res) => {
    try {
        ...
        return apiResponse.successResponseWithData(res, 'Flight retrieval by ID successful!', flight);
    } catch (err) {
        // Log and handle errors
...
exports.update = async (req, res) => {
    try {
        ...
        if (updatedFlight) {
            return apiResponse.successResponse(res, 'Flight update successful!');
        } else {
            return apiResponse.errorResponse(res, 'Flight not found or could not be updated');
        }
    } catch (err) {
        // Log and handle errors
...
exports.searchFlights = async (req, res) => {
    try {
        ...
        if (flights.length > 0) {
            return apiResponse.successResponseWithData(res, 'Flight search successful!', flights);
        } else {
